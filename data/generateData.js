...
writeExperiences.write('title,city,state,country,category,activity,averageRating, numberOfReviews,duration,groupSize,includes,cuisine,hostedLanguages,costPerPerson,imageUrls,videoUrl\n');
...
function writeTenMillionExperiences(writer, encoding, callback) {
  ...
  function write() {
    ...
    do {
      ...
      const data = `${experience.title},${experience.city},${experience.state},${experience.country},${experience.category},${experience.activity},${experience.averageRating},${experience.numberOfReviews},${experience.duration},${experience.groupSize},${includes},${experience.cuisine},${hostedLanguages},${experience.costPerPerson},${imageUrls},${experience.videoUrl}\n`;
